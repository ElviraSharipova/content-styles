        ...
        <MTxt>
            ...
            <div style={{background: " #f0f0f0",  overflow: "auto", width: "auto", border: "solid gray", borderWidth: ".1em .1em .1em .8em", padding: ".2em .6em"}}>
                <pre style={{margin: " 0",  lineHeight: " 125%"}}>
                    ...
                    <span style={{color: " #60a0b0",  fontStyle: " italic"}}>#Ехал robot через robot</span><br/>
                    robot<span style={{color: " #666666"}}>.</span>move()<br/>
                    robot<span style={{color: " #666666"}}>.</span>move()<br/>
                    robot<span style={{color: " #666666"}}>.</span>move()<br/>
                    <span style={{color: " #60a0b0",  fontStyle: " italic"}}>#Видит robot - robot robot</span><br/>
                    robot<span style={{color: " #666666"}}>.</span>rotate_right()<br/>
                    <span style={{color: " #60a0b0",  fontStyle: " italic"}}>#Сунул robot robot в robot</span><br/>
                    robot<span style={{color: " #666666"}}>.</span>move()<br/>
                    robot<span style={{color: " #666666"}}>.</span>move()<br/>
                    <span style={{color: " #60a0b0",  fontStyle: " italic"}}>#Robot robot robor robot!</span><br/>
                </pre>
            </div>
        </MTxt>
