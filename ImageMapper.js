...
var ImageMapper = (function (_Component) {
	...
	function ImageMapper(props) {
		...
		this.styles = {
			container: {},
			//canvas: _extends({}, absPos, { pointerEvents: "none", zIndex: 2, width: "100vw", height: "100vh" }),
			canvas: _extends({}, absPos, { pointerEvents: "none", zIndex: 2}),
			img: _extends({}, absPos, { zIndex: 1, userSelect: "none", width: "100vw", height: "100vh", maxWidth: "100vw", maxHeight: "100vh"}),
	...
	_createClass(ImageMapper, [{
		...
		value: function scaleCoords(coords) {
			...
			var scale = width && imgWidth && imgWidth > 0 ? imgWidth / width : 1;
      //scale = 1856/1485;
      //scale = width_true/1485;
